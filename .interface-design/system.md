...
- O encerramento do resumo transforma a face neural em um canteiro vertical procedural: estrutura de concreto inacabada, andaimes, tela de proteção, materiais e guindaste. A cena é geometria Three.js gerada no navegador, nunca fotografia de mansão ou imagem estática, e a placa usa exclusivamente `CURITIBA EMPREITEIRA`.
...
- A autoria do projeto tem uma página cinematográfica própria, aberta em rota separada por ação explícita, com os cinco integrantes e suas funções reais. A página usa uma cena facial neural 3D isolada do terminal e do reconhecimento para não disputar GPU com a câmera.
