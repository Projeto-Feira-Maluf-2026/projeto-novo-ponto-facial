...
- O resumo não exibe uma ação “Ativar experiência completa”: em condições normais o movimento começa imediatamente e mantém apenas o controle “Pausar movimento”. `prefers-reduced-motion` continua sendo respeitado automaticamente.
